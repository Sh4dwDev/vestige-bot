...
export interface ApiError {
    ...
    code: 'signed_out' | 'not_linked' | 'server_unreachable' | 'not_found' | 'bad_request' | 'rate_limited' | 'server_error';
    /** Written for a player to read. Safe to show verbatim. */
    reason: string;
}
export declare const apiError: (code: ApiError["code"], reason: string) => ApiError;
 ...
 */
export declare const displayPoints: (balance: number) => number;
/**
 ...
 */
export declare function toVaultSlot(raw: {
    slot: string;
    species: string;
    growth: number;
    female: boolean;
