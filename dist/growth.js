...
const SLACK = 0.01;
export function growthFloor(ctx) {
...
export function setGrowthFloor(ctx, percent, heal = true) {
 ...
 */
export function belowFloor(players, floor) {
    return players
 ...
 * shares a pass with.
 */
export async function runGrowthFloor(ctx, players, log) {
