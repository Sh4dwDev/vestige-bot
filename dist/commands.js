...
export const commandData = [
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((s) => s.setName('expiry').setDescription('How long a look survives without being worn')
        ...
        .addSubcommand((c) => c.setName('reward').setDescription('Points per claim, before the tier multiplier')
        ...
        .addSubcommand((c) => c.setName('classes').setDescription('Write every nest class this build exposes to the mod log')))
    ...
    new SlashCommandBuilder()
        ...
        .addIntegerOption((o) => o.setName('minutes').setDescription('Default 60. 0 gives it to anyone linked')
        .setMinValue(0).setMaxValue(10_000).setRequired(true)))
