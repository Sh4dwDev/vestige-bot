...
export const commandData = [
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption((o) => o.setName('species').setDescription('Exact species, e.g. Tyrannosaurus')
        .setRequired(true))
        .addStringOption((o) => o.setName('slot').setDescription('Slot name they will see (default: gift)'))
        .addIntegerOption((o) => o.setName('growth').setDescription('Growth percent, default 100')
        .setMinValue(5).setMaxValue(100))
        .addStringOption((o) => o.setName('mutations').setDescription('Up to 4, comma separated'))
        .addBooleanOption((o) => o.setName('female').setDescription('Female? Display only — gender cannot be set'))))
