...
import { backfillEarlyRole, earlyMinutes, earlyRole, holders, setEarlyMinutes, setEarlyRole, } from './earlymember.js';
...
import { applyLookIndexes, WHOLE_LOOK, BUILT_IN, encodeColours, captureBaseline, patternLetter, PATTERN_CHOICES, hexToInt, hexToLinear, linearToHex, PARTS, PRESETS, presetLook, restoreBaseline, } from './skins.js';
...
export const commandData = [
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((c) => c.setName('history').setDescription('Recent sessions for a staff member')
        .addUserOption((o) => o.setName('staff').setDescription('Whose history')))
        .addSubcommand((c) => c.setName('force-off').setDescription('End somebody else session')
        .addUserOption((o) => o.setName('staff').setDescription('Who to take off duty').setRequired(true))),
    new SlashCommandBuilder()
        .setName('profile')
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((s) => s.setName('channel').setDescription('Put the population panel up')
        ...
        .addStringOption((o) => o.setName('species').setDescription('From the live server list')
        .setAutocomplete(true).setRequired(true))
        .addIntegerOption((o) => o.setName('growth').setDescription('Growth percent, default 100')
        .setMinValue(5).setMaxValue(100))
        .addStringOption((o) => o.setName('gender').setDescription('Shown on the slot only')
        ...
        .addStringOption((o) => o.setName('slot').setDescription('Slot name (default: the species)'))))
        ...
        .addSubcommand((s) => s.setName('expiry').setDescription('How long a look lasts unworn')
        .addIntegerOption((o) => o.setName('hours').setDescription('Default 6')
        ...
        .setRequired(true)))
        .addSubcommand((s) => s.setName('save').setDescription('Save current colours as a preset')
        ...
        .addIntegerOption((o) => o.setName('tier').setDescription('1 to 4')
        .setMinValue(1).setMaxValue(4).setRequired(true)))
        .addSubcommand((s) => s.setName('multiplier').setDescription('What a tier is worth')
        .addIntegerOption((o) => o.setName('tier').setDescription('1 to 4')
        .setMinValue(1).setMaxValue(4).setRequired(true))
        .addNumberOption((o) => o.setName('multiplier').setDescription('e.g. 2 for double')
        .setMinValue(0).setMaxValue(20).setRequired(true)))
        .addSubcommand((s) => s.setName('killpoints').setDescription('Base kill points, before tier')
        ...
        .addSubcommand((s) => s.setName('ai').setDescription('Whether cleanup also clears AI')
        .addBooleanOption((o) => o.setName('on').setDescription('Toggle AI off and back on each cycle')
        .setRequired(true)))
        ...
        .addSubcommand((c) => c.setName('whitelist').setDescription('Whitelist on, off, add')
        ...
        .addUserOption((o) => o.setName('user').setDescription('Who').setRequired(true)))
        .addSubcommand((c) => c.setName('grow').setDescription('Grow everyone to a size')
        .addIntegerOption((o) => o.setName('percent').setDescription('5 to 100')
        .setMinValue(5).setMaxValue(100).setRequired(true))
        .addBooleanOption((o) => o.setName('heal').setDescription('Also fill them up'))
        .addBooleanOption((o) => o.setName('keep').setDescription('Keep it up on respawn')))
        .addSubcommand((c) => c.setName('growoff').setDescription('Stop the growth floor')))
        ...
        .addSubcommand((s) => s.setName('now').setDescription('Restart the server now')
        ...
        .addChannelTypes(ChannelType.GuildText).setRequired(true))))
        .addSubcommandGroup((g) => g.setName('nest').setDescription('Put a nest in the world')
        .addSubcommand((c) => c.setName('place').setDescription('Spawn one where you are standing')
        .addStringOption((o) => o.setName('type').setDescription('Which nest. Default a large mound')
        .addChoices({ name: 'Mound (large)', value: 'BP_Nest_Mound_Large_H_C' }, { name: 'Mound (small)', value: 'BP_Nest_Mound_Small_H_C' }, { name: 'Burrow', value: 'BP_Nest_Burrow_H_C' }, { name: 'Tree', value: 'BP_Nest_Tree_H_C' })))
        .addSubcommand((c) => c.setName('classes').setDescription('List nest classes to the mod log')))
        ...
        .addChannelOption((o) => o.setName('channel').setDescription('Where it announces')
        .addChannelTypes(ChannelType.GuildText).setRequired(true))))
        .addSubcommandGroup((g) => g.setName('drop').setDescription('A race to find it')
        .addSubcommand((c) => c.setName('start').setDescription('Hide one near the players')
        .addIntegerOption((o) => o.setName('reward').setDescription('Points. Default 1000')
        .setMinValue(0).setMaxValue(100_000))
        .addIntegerOption((o) => o.setName('minutes').setDescription('Minutes. Default 20')
        .setMinValue(2).setMaxValue(120))
        .addIntegerOption((o) => o.setName('radius').setDescription('Close enough. Default 12')
        .setMinValue(5).setMaxValue(100))
        .addStringOption((o) => o.setName('skin').setDescription('A skin the finder keeps')
        .setAutocomplete(true)))
        .addSubcommand((c) => c.setName('status').setDescription('Where it is'))
        .addSubcommand((c) => c.setName('stop').setDescription('Call it off'))
        .addSubcommand((c) => c.setName('channel').setDescription('Where it is posted')
    ...
    new SlashCommandBuilder()
        ...
        .addSubcommand((c) => c.setName('reward').setDescription('Points per claim, before tier')
        .addIntegerOption((o) => o.setName('points').setDescription('Default 150')
        ...
        .addSubcommandGroup((g) => g.setName('founders').setDescription('Early Member skins and role')
        .addSubcommand((c) => c.setName('role').setDescription('The role that unlocks the skins')
        .addRoleOption((o) => o.setName('role').setDescription('Given automatically until the cap is hit')
        .setRequired(true)))
        .addSubcommand((c) => c.setName('backfill')
        .setDescription('Give it to everyone who qualifies'))
        .addSubcommand((c) => c.setName('playtime').setDescription('How long they must play to earn the role')
        .addIntegerOption((o) => o.setName('minutes').setDescription('Default 60. 0 means no requirement')
        .setMinValue(0).setMaxValue(10_000).setRequired(true)))
        ...
        .setMinValue(0).setMaxValue(100_000))))
        .addSubcommandGroup((g) => g.setName('duty').setDescription('Staff duty panel and logging')
        ...
        .addSubcommand((c) => c.setName('roles').setDescription('Staff and on-duty roles')
        ...
        .addRoleOption((o) => o.setName('senior').setDescription('May force others off duty')))
        .addSubcommand((c) => c.setName('log').setDescription('Where sessions are recorded')
        .addChannelOption((o) => o.setName('channel').setDescription('Session log channel')
        .addChannelTypes(ChannelType.GuildText).setRequired(true)))
        .addSubcommand((c) => c.setName('limit').setDescription('Hours before a session closes')
        .addIntegerOption((o) => o.setName('hours').setDescription('Default 4')
        .setMinValue(1).setMaxValue(24).setRequired(true)))
        ...
        .addSubcommand((c) => c.setName('reward').setDescription('Points per parent')
        ...
        .addChannelOption((o) => o.setName('channel').setDescription('Where listings go')
        .addChannelTypes(ChannelType.GuildText).setRequired(true)))
        .addSubcommand((c) => c.setName('off').setDescription('Close the market'))
        .addSubcommand((c) => c.setName('refresh').setDescription('Repost listings that lost their message'))
...
async function handleAdminPoints(ctx, i, action) {
    if (action === 'weekend') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, perHour > 0 ? 'Weekend bonus set' : 'Weekend bonus off', perHour === 0
 ...
 */
async function handleProfile(ctx, i) {
    const link = ctx.db.linkFor(i.user.id);
    if (!link) {
        await i.reply({
            embeds: [embed(COLORS.warn, 'Not linked', 'Run `/link` first so the bot knows which Steam account is yours.')],
            flags: MessageFlags.Ephemeral,
        });
        return;
    }
...
async function handleSkin(ctx, i, action) {
    ...
    if (action === 'expiry') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Skin expiry set', `A look is forgotten after **${hours} hours** without being worn.\n\n` +
...
async function handleCleanup(ctx, i, action) {
    ...
    if (action === 'status') {
        ...
        await i.editReply({
            embeds: [embed(COLORS.info, 'Cleanup', '**Scheduled cleanup** — ' +
                    (cleanup.enabled
    ...
    if (action === 'ai') {
        ...
        setCleanupAI(ctx, on);
        await i.reply({
            embeds: [embed(COLORS.good, on ? 'AI clearing on' : 'AI clearing off', on
    ...
    if (action === 'enforce') {
        ...
        if (!on) {
            ...
            try {
                ...
                await i.editReply({
                    embeds: [embed(COLORS.good, 'Enforcement off', 'Caps announce again rather than blocking.' +
                            (restored.length > 0
                ...
                await i.editReply({
                    embeds: [embed(COLORS.bad, 'Enforcement off, but the menu is unchanged', `${describeError(err)}\n\n⚠️ Any species locked right now is still ` +
        ...
        try {
            ...
            await i.editReply({
                embeds: [result.verified
                        ? embed(COLORS.good, 'Enforcement on', 'A species at its cap is now removed from the spawn menu, and comes ' +
                        ...
                        : embed(COLORS.bad, 'This server did not accept it', `${enforcementFault(ctx) ?? 'the write did not take'}.\n\n` +
            ...
            await i.editReply({
                embeds: [embed(COLORS.bad, 'Could not reach the server', `${describeError(err)}\n\nEnforcement is off. Try again when it is up.`)],
            });
        }
        return;
    }
...
async function handleDrop(ctx, i, action) {
    if (action === 'channel') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Drop channel set', `The drop and its hints are posted in <#${channel.id}>, and announced in `
    ...
    if (action === 'stop') {
        ...
        saveDrop(ctx, null);
        await i.reply({
            embeds: [embed(COLORS.good, 'Drop called off', `It was at Lat **${hud(running.y)}**, Long **${hud(running.x)}**. Nobody was paid.`)],
            flags: MessageFlags.Ephemeral,
        });
        return;
    }
    if (action === 'status') {
        ...
        if (!running) {
            await i.reply({
                embeds: [embed(COLORS.quiet, 'Nothing out there', 'Start one with `/admin drop start` while people are in game.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
...
async function handleContest(ctx, i, action) {
    if (action === 'channel') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Contest channel set', `Results are posted in <#${channel.id}>. The start and the win are also `
    ...
    if (action === 'stop') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, running ? 'Contest called off' : 'Nothing running', running
    ...
    if (action === 'status') {
        ...
        if (!running) {
            await i.reply({
                embeds: [embed(COLORS.quiet, 'Nothing running', 'Stand somewhere good and use `/admin contest start`.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
        ...
        const holders = players.filter((p) => p.steam && inside(running, p))
            .map((p) => p.steam);
        await i.editReply({
            embeds: [buildContestEmbed(running, steamNamer(ctx), { holders, contested: holders.length > 1 })],
        });
        return;
    }
    ...
    if (!link) {
        await i.reply({
            embeds: [embed(COLORS.warn, 'Link your account first', 'The contest starts where you are standing, so the bot needs to know '
    ...
    if (activeContest(ctx)) {
        await i.editReply({
            embeds: [embed(COLORS.warn, 'One at a time', 'A contest is already running. `/admin contest stop` ends it first — two '
                    + 'at once would split everybody and neither would be fought over.')],
        });
        return;
    }
    const me = (await ctx.mod.players().catch(() => []))
        .find((p) => p.steam === link.steamId);
    if (!me || me.x === undefined || me.y === undefined) {
        await i.editReply({
            embeds: [embed(COLORS.warn, 'Cannot see where you are', 'Join the server, stand where you want it, and run this again.')],
        });
        return;
    }
    const skin = i.options.getString('skin')?.trim();
    ...
    await i.editReply({
        embeds: [embed(COLORS.good, 'Contest started', `**${contest.name}** at Lat **${hud(contest.y)}**, Long **${hud(contest.x)}**.\n\n`
 ...
 */
async function handleNest(ctx, i, action) {
    const link = ctx.db.linkFor(i.user.id);
    if (!link) {
        await i.reply({
            embeds: [embed(COLORS.warn, 'Link your account first', 'The nest goes where you are standing, so the bot needs to know which '
                    + 'character is yours.')],
            flags: MessageFlags.Ephemeral,
        });
        return;
    ...
    if (action === 'classes') {
        ...
        await i.editReply({
            embeds: [embed(listed.ok ? COLORS.good : COLORS.bad, listed.ok ? 'Written to the mod log' : 'Could not list them', `${listed.msg}\n\nRead them with \`pnpm log\` — lines starting `
                    + '`nest class:`.')],
        });
        return;
    }
    ...
    await i.editReply({
        embeds: [embed(COLORS.good, 'Nest placed', `A **${type.replace(/^BP_Nest_|_H_C$/g, '').replace(/_/g, ' ')}** is now `
 ...
 * duty.
 */
async function handleDutyCommand(ctx, i) {
    const action = i.options.getSubcommand(true);
    const member = i.member;
    const roleIds = member?.roles?.cache?.map((r) => r.id) ?? [];
    if (!member || !isStaff(ctx, roleIds)) {
        await i.reply({
            embeds: [embed(COLORS.bad, 'Staff only', 'Duty Mode is for staff. Ask an admin to check your roles if that looks wrong.')],
            flags: MessageFlags.Ephemeral,
        });
        return;
    }
    ...
    if (action === 'status') {
        ...
        await i.reply({
            embeds: [open
                    ? embed(COLORS.good, '🟢  On duty', `Session **${open.sessionId}** · **${open.staffRank}**\n`
                        + `Started ${stamp(open.startedAtUtc)}\n`
                        + `Duration **${formatDuration(durationBetween(open.startedAtUtc, new Date().toISOString()))}**\n`
                        + `Steam **${open.steamId}**`)
    ...
    if (action === 'history') {
        ...
        if (who.id !== i.user.id && !isSenior(ctx, roleIds)) {
            await i.reply({
                embeds: [embed(COLORS.bad, 'Not allowed', 'Only senior staff can read somebody else history.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
    ...
    if (action === 'force-off') {
        if (!isSenior(ctx, roleIds)) {
            await i.reply({
                embeds: [embed(COLORS.bad, 'Not allowed', 'Only senior staff can take somebody else off duty.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
        ...
        const result = await goOffDuty(ctx, target, who.id, 'Forced off duty by senior staff', describeError);
        if (!result.ok) {
        ...
        await i.editReply({
            embeds: [embed(COLORS.good, 'Taken off duty', `${who} is off duty after `
    ...
    await i.deferReply({ flags: MessageFlags.Ephemeral });
    if (action === 'on') {
        const result = await goOnDuty(ctx, member, rankOf(roleIds, ranksFor(ctx)), 'command', () => undefined);
        if (!result.ok) {
        ...
        await i.editReply({
            embeds: [embed(COLORS.good, '🟢  On duty', `Session **${result.session.sessionId}** started `
                    + `${stamp(result.session.startedAtUtc)}.\n\nIt closes itself after `
                    + `**${maxHours(ctx)} hours** if you forget.`)],
        });
        return;
    }
    const result = await goOffDuty(ctx, member, i.user.id, 'Staff went off duty', () => undefined);
    if (!result.ok) {
        await i.editReply({ embeds: [embed(COLORS.warn, 'Not ended', result.reason)] });
        return;
    }
    ...
    await i.editReply({
        embeds: [embed(COLORS.good, '⚪  Off duty', `**${formatDuration(result.session.durationSeconds ?? 0)}** on duty, `
                + `recorded as **${result.session.sessionId}**.`)],
    });
}
...
Most senior first. Somebody holding two ranks is `
    ...
    if (action === 'roles') {
        ...
        if (staff)
            setDutySetting(ctx, 'staffRole', staff.id);
        if (onduty)
            setDutySetting(ctx, 'onDutyRole', onduty.id);
        if (senior)
            setDutySetting(ctx, 'seniorRole', senior.id);
        await i.reply({
            embeds: [embed(COLORS.good, 'Duty roles set', `Staff: ${staffRole(ctx) ? `<@&${staffRole(ctx)}>` : 'unset'}\n`
    ...
    if (action === 'log') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Duty log set', `Sessions are recorded in <#${channel.id}>. The start message is edited `
    ...
    if (action === 'limit') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Limit set', `A session closes itself after **${hours} hours** and is logged as such. `
    ...
    if (action === 'status') {
        ...
        await i.reply({
            embeds: [embed(COLORS.info, 'Duty setup', `Staff role: ${staffRole(ctx) ? `<@&${staffRole(ctx)}>` : '**unset**'}\n`
    ...
    try {
        await postOrEdit(ctx.db, i.client, channel.id, DUTY_PANEL_MESSAGE_KEY, [buildDutyPanel()], dutyPanelRows());
        await i.editReply({
            embeds: [embed(COLORS.good, 'Duty panel posted', `It is in <#${channel.id}>, and updates in place rather than posting a `
...
async function handleCalibrate(ctx, i) {
    ...
    if (!bounds) {
        await i.editReply({
            embeds: [embed(COLORS.bad, 'Could not use that reading', `You read as Lat **${hud(me.y)}**, Long **${hud(me.x)}**, but that ` +
...
async function handleHeatmap(ctx, i, action) {
    ...
    if (action === 'image') {
        ...
        await i.editReply({
            embeds: [data
                    ? embed(COLORS.good, 'Map picture set', 'The heat will be drawn over it from the next refresh.\n\n' +
    ...
    if (action === 'bounds') {
        ...
        if (latMin === latMax || longMin === longMax) {
            await i.reply({
                embeds: [embed(COLORS.warn, 'Those edges are the same', 'Opposite edges of a map cannot share a coordinate — everything would ' +
                        'land on one line.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Bounds pinned', `Bottom **${latMin}** to top **${latMax}** Lat, left **${longMin}** to ` +
                    `right **${longMax}** Long.\n\n` +
...
async function handleBackup(ctx, i, action) {
    ...
    if (!cfg) {
        await i.editReply({
            embeds: [embed(COLORS.warn, 'No backup database configured', 'Set `MYSQL_HOST`, `MYSQL_USER`, `MYSQL_PASSWORD` and `MYSQL_DATABASE` ' +
    ...
    try {
        if (action === 'now') {
            ...
            await i.editReply({
                embeds: [embed(COLORS.good, 'Snapshot taken', `**${result.rows}** rows across **${result.tables}** tables.\n\n` +
        ...
        if (action === 'list') {
            ...
            await i.editReply({
                embeds: [embed(COLORS.info, 'Snapshots', snapshots.length === 0
                        ? 'None yet. `/admin backup now` takes one.'
                        : snapshots.map((snap) => `\`${snap.takenAt}\` — <t:${Math.floor(snap.takenAt / 1000)}:R> · ` +
        ...
        if (action === 'restore') {
            ...
            if (confirm !== 'REPLACE') {
                await i.editReply({
                    embeds: [embed(COLORS.warn, 'Not confirmed', 'This **replaces every table** with the snapshot, and anything that ' +
            ...
            await i.editReply({
                embeds: [embed(COLORS.good, 'Restored', `**${result.rows}** rows across **${result.tables}** tables, from ` +
        ...
        const snapshots = await listSnapshots(cfg);
        await i.editReply({
            embeds: [embed(COLORS.info, 'Backups', `Backing up to \`${cfg.database}\` on \`${cfg.host}\`.\n\n` +
                    (last === 0
...
// ------------------------------------------------------------- bounties --
async function handleBounties(ctx, i, action) {
    if (action === 'on' || action === 'off') {
        setBountiesEnabled(ctx, action === 'on');
        const settings = bountySettings(ctx);
        await i.reply({
            embeds: [action === 'on'
                    ? embed(COLORS.good, 'Bounties on', 'A species over its cap now gets a bounty posted on it automatically: ' +
                    ...
                    : embed(COLORS.good, 'Bounties off', 'Nothing new will be posted. Anything already on the board stays until ' +
    ...
    if (action === 'reward') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Bounty reward set', `**${points}** points a kill, before the tier multiplier — so an apex is ` +
    ...
    if (action === 'clear') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Board cleared', had === 0 ? 'There were none up.' : `Took down **${had}**.`)],
            flags: MessageFlags.Ephemeral,
        });
        return;
    }
    ...
    await i.reply({
        embeds: [embed(COLORS.info, '💰  Bounties', (settings.enabled ? '**On.**' : '**Off.**') +
...
async function handleFounders(ctx, i, action) {
    if (action === 'role') {
        ...
        await i.reply({
            embeds: [problems.length
                    ...
                    : embed(COLORS.good, 'Early Member role set', `${role} is given automatically to anyone who joins, until ` +
    ...
    if (action === 'backfill') {
        ...
        if (!earlyRole(ctx)) {
            await i.reply({
                embeds: [embed(COLORS.warn, 'No role chosen', 'Pick one with `/setup founders role` first.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
        ...
        await i.editReply({
            embeds: [embed(COLORS.good, 'Backfill done', `**${result.given}** given the role, **${result.already}** already had it.` +
    ...
    if (action === 'playtime') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Playtime set', minutes > 0
...
`
    ...
    if (group === 'duty')
        return handleDutySetup(ctx, i, action);
    if (group === 'peaks')
...
async function handleBotAdmin(ctx, i, action) {
    if (action === 'log') {
        ...
        if (!channel) {
            await i.reply({
                embeds: [embed(COLORS.warn, 'Pick a channel', 'Give it a channel, or use `/admin bot logoff` to stop logging.')],
                flags: MessageFlags.Ephemeral,
            });
            return;
        }
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Staff log on', `Every \`/admin\` and \`/setup\` command now goes to <#${channel.id}> — who ran `
    ...
    if (action === 'logoff') {
        ...
        await i.reply({
            embeds: [embed(COLORS.good, 'Staff log off', 'Staff actions are no longer recorded. What was written stays where it is.')],
            flags: MessageFlags.Ephemeral,
        });
        return;
    }
