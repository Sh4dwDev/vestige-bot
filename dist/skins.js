 ...
 */
export const WHOLE_LOOK = { theme: 0, variation: 0 };
/**
...
export async function applyLookIndexes(ctx, steamId, look) {
    ...
    if (look.theme !== undefined)
        args['theme'] = look.theme;
    if (look.variation !== undefined)
        args['variation'] = look.variation;
 ...
 */
export function completeLook(colours) {
    const pick = (...names) => {
...
export const presetLook = (ctx, name) => {
