...
export const commandData = [
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommandGroup((g) =>
      g.setName('bot').setDescription('Who may use these commands')
        ...
        .addSubcommand((s) =>
          s.setName('log').setDescription('Where staff actions go')
            .addChannelOption((o) =>
              o.setName('channel').setDescription('The log channel')
          ...
          s.setName('notices').setDescription('How on-screen notices are shown')
            .addStringOption((o) =>
              o.setName('style').setDescription('banner leaves prime alone').setRequired(true)
                .addChoices(
                  { name: 'Banner (keeps prime visible)', value: 'banner' },
                  { name: 'Persistent (hides prime)', value: 'persistent' },
                )))
        .addSubcommand((s) =>
          s.setName('gamelog').setDescription('Also forward the game log')
            .addBooleanOption((o) =>
    ...
    .addSubcommandGroup((g) =>
      g.setName('cleanup').setDescription('How quickly the world tidies itself')
        ...
        .addSubcommand((s) =>
          s.setName('every').setDescription('Clear corpses on a schedule')
            .addIntegerOption((o) =>
    ...
    .addSubcommandGroup((g) =>
      g.setName('mod').setDescription('Moderation')
        ...
        .addSubcommand((c) =>
          c.setName('ban').setDescription('Ban a Steam account')
            .addUserOption((o) => o.setName('user').setDescription('Who').setRequired(true))
          ...
          s.setName('enforce')
            ...
            .addBooleanOption((o) =>
              o.setName('on').setDescription('Remove full species from the spawn menu')
                .setRequired(true)))
        .addSubcommand((s) =>
          s.setName('tryout').setDescription('Play a hidden species yourself')
            .addStringOption((o) =>
              o.setName('species')
      ...
      g.setName('hunt').setDescription('One player is the target')
        .addSubcommand((c) =>
          c.setName('start').setDescription('Put a price on somebody')
            ...
            .addIntegerOption((o) =>
              o.setName('reveal').setDescription('Minutes between calls. Default 3')
          ...
          c.setName('start').setDescription('Start one where you are standing')
            ...
            .addIntegerOption((o) =>
              o.setName('reward').setDescription('Points for the winner. Default 750')
                .setMinValue(0).setMaxValue(100_000))
            .addIntegerOption((o) =>
              o.setName('radius').setDescription('How close counts. Default 30')
            ...
            .addBooleanOption((o) =>
              o.setName('shared').setDescription(
                'Everybody on it wins. Default off')))
      ...
      g.setName('points').setDescription('Adjust player points')
        ...
        .addSubcommand((s) =>
          s.setName('weekend').setDescription('Extra points per hour at the weekend')
            .addIntegerOption((o) =>
              o.setName('perhour').setDescription('Added flat. 0 turns it off')
  ...
  new SlashCommandBuilder()
    ...
    .addSubcommandGroup((g) =>
      g.setName('streak').setDescription('Daily play streaks')
        ...
        .addSubcommand((c) =>
          c.setName('reward').setDescription('What a day is worth')
            .addIntegerOption((o) =>
              o.setName('step').setDescription('Per day. Default 40')
                .setMinValue(0).setMaxValue(5_000).setRequired(true))
            .addIntegerOption((o) =>
              o.setName('cap').setDescription('Most per day. Default 400')
                .setMinValue(0).setMaxValue(50_000).setRequired(true)))
        .addSubcommand((c) => c.setName('status').setDescription('What is set')),
    )
    .addSubcommandGroup((g) =>
      g.setName('weekly').setDescription('The weekly board')
        .addSubcommand((c) =>
          c.setName('on').setDescription('Run it, posting results here')
            .addChannelOption((o) =>
              o.setName('channel').setDescription('Where results go')
                .addChannelTypes(ChannelType.GuildText).setRequired(true)))
        .addSubcommand((c) => c.setName('off').setDescription('Stop running it'))
        .addSubcommand((c) =>
          c.setName('skin').setDescription('What the top three keep')
            .addStringOption((o) =>
              o.setName('preset').setDescription('A skin preset')
                .setAutocomplete(true).setRequired(true)))
          ...
          c.setName('panel').setDescription('Put the duty panel in a channel')
            .addChannelOption((o) =>
              o.setName('channel').setDescription('Where the panel lives')
                .addChannelTypes(ChannelType.GuildText).setRequired(true)))
        .addSubcommand((c) =>
          c.setName('rank').setDescription('Add or update a staff rank')
            .addRoleOption((o) =>
              o.setName('role').setDescription('The role that grants it').setRequired(true))
            .addStringOption((o) =>
              o.setName('label').setDescription('Shown in logs, e.g. Moderator')
                .setRequired(true))
            .addIntegerOption((o) =>
              o.setName('level').setDescription('Higher is more senior. Default 10')
                .setMinValue(1).setMaxValue(100))
            .addBooleanOption((o) =>
              o.setName('forceoff').setDescription('May end other sessions. Default no')))
        .addSubcommand((c) =>
          c.setName('unrank').setDescription('Remove a staff rank')
            .addRoleOption((o) =>
          ...
          c.setName('reward').setDescription('Points per parent')
            .addIntegerOption((o) =>
              o.setName('points').setDescription('Default 400')
                .setMinValue(0).setMaxValue(100_000).setRequired(true)))
        .addSubcommand((c) =>
          c.setName('radius').setDescription('How close a parent must be')
            .addIntegerOption((o) =>
              o.setName('hud').setDescription('Default 20')
                .setMinValue(1).setMaxValue(200).setRequired(true)))
        .addSubcommand((c) =>
          c.setName('condition').setDescription('Which prime flag is nested in')
            .addIntegerOption((o) =>
    ...
    .addSubcommandGroup((g) =>
      g.setName('market').setDescription('Players buying and selling dinosaurs')
        .addSubcommand((c) =>
          c.setName('panel').setDescription('Put the market panel somewhere')
            .addChannelOption((o) =>
              o.setName('channel').setDescription('Where the buttons live')
                .addChannelTypes(ChannelType.GuildText).setRequired(true))
            .addChannelOption((o) =>
...
async function handleGive(ctx: Ctx, i: ChatInputCommandInteraction): Promise<void> {
  ...
  try {
    ...
    if (result.ok) await tell(ctx, link.steamId, `A ${species} was added to your archive`);
...
async function handleHunt(
  ...
  if (action === 'status') {
    ...
    const nearest = quarry?.x !== undefined && quarry.y !== undefined
      ? live
        ...
        .map((p) => hud(distance(p.x as number, p.y as number, quarry.x as number, quarry.y as number)))
        .sort((a, b) => a - b)[0] ?? null
      : null;
  ...
  if (!quarry) {
    await i.editReply({
      embeds: [embed(COLORS.warn, 'They are not in game',
        `${target} is not on a dinosaur right now, so there would be nothing to `
...
async function handleStreaks(
  ...
  if (action === 'on' || action === 'off') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, action === 'on' ? 'Streaks on' : 'Streaks off',
        action === 'on'
  ...
  if (action === 'reward') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Streak reward set',
        `Day one pays **${step}**, day five pays **${Math.min(cap, step * 5)}**, and `
...
`
  ...
  await i.reply({
    embeds: [embed(COLORS.info, '🔥  Streaks',
      `Streaks are **${streaksEnabled(ctx) ? 'on' : 'off'}**.
`
...
async function handleWeekly(
  ...
  if (action === 'on') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Weekly board on',
        `Results are posted in <#${channel.id}> when each week ends.\n\n`
  ...
  if (action === 'off') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Weekly board off',
        'No more weekly results. What people have earned is still recorded, so '
  ...
  if (action === 'skin') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Weekly prize set',
        `The top **${PODIUM}** each week keep the **${preset}** skin.`)],
      flags: MessageFlags.Ephemeral,
    });
    return;
  }
...
const rankLines = (ranks: ReturnType<typeof dutyRanks>): string =>
  ranks
...
async function handleDutySetup(
  ...
  if (action === 'rank') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Rank saved',
        `${rankLines(ranks)}
...
Most senior first. Somebody holding two ranks is `
  ...
  if (action === 'unrank') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Rank removed',
        ranks.length > 0
          ? rankLines(ranks)
...
`
  ...
  if (group === 'streak') return handleStreaks(ctx, i, action);
  if (group === 'weekly') return handleWeekly(ctx, i, action);
...
async function handleBotAdmin(
  ...
  if (action === 'notices') {
    ...
    await i.reply({
      embeds: [embed(COLORS.good, 'Notice style set',
        style === 'banner'
